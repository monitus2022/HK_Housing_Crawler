...
class AgencyProcessor(BaseProcessor):
    def __init__(self):
        super().__init__()
        self.transaction_file_path = self.data_storage_path / "all_transactions.json"
        self.estate_info_json_path = self.data_storage_path / "estate_info.json"
        self.processed_estate_info_json_path = (
            self.data_storage_path / "processed_estate_info.json"
        )
        self._legacy_transaction_file_path = self.data_storage_path / "transactions.csv"

    def process_all_transactions_json(self) -> list[dict]:
